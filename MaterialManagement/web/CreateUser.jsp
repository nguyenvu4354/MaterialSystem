...
<html lang="en">
    ...
    <body>
                        ...
                        <form action="${pageContext.request.contextPath}/create-user" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="d-grid gap-2 mb-3">
                                        <a href="UserList" class="btn btn-outline-secondary btn-lg rounded-1">Back to User List</a>
                                    </div>
                                </div>
                            </div>
                        </form>
        ...
        <script src="https://code.iconify.design/iconify-icon/1.0.iranno:1.0.7/iconify-icon.min.js"></script>
        <script>
