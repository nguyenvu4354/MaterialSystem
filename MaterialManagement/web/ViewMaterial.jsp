                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="material-image">
                            <img src="images/material/${m.materialsUrl}" alt="${m.materialName}" style="width:200px;height:200px;object-fit:cover;" onerror="this.onerror=null;this.src='images/material/default.jpg';">
                        </div>
                    </div>
                    <div class="col-md-8">
                        <h2 class="mb-4 material-title">${empty m.materialName ? 'Không có thông tin' : m.materialName}</h2>
