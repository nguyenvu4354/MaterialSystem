...
<html lang="en">
    <head>
        ...
        <style>
            ...
            .status-approved {
                background-color: #198754; /* Màu xanh cho approved */
            }
            .status-rejected {
                background-color: #dc3545; /* Màu đỏ cho rejected */
            }
        </style>
    </head>
    <body>
        <div class="container">
            ...
            <h2>Repair Request Details - Request Code: <%= requestId %>
                <span class="status-tag
                    ...
                    <%= request.getAttribute("status") != null ? request.getAttribute("status") : "N/A" %>
                </span>
            </h2>
