        ...
        <div class="row">
            ...
            <div class="col-md-9 col-lg-10 content px-md-4">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h2 class="text-primary fw-bold display-6 border-bottom pb-2"><i class="fas fa-list"></i> Category List</h2>
                    <div>
                ...
                <div class="row search-box">
                    <div class="col-md-12">
                        <form action="Category.jsp" method="GET" class="d-flex gap-2 flex-wrap">
                            ...
                            <input type="text" name="categoryName" class="form-control" 
                                   ...
                                   style="width: 200px; height: 50px"/>
                            <select name="priority" class="form-select" style="width: 200px; height: 50px">
                        ...
                        <nav>
                            <ul class="pagination">
                                <li class="page-item ${currentPage == 1 ? 'disabled' : ''}">
                                    <a class="page-link" href="Category.jsp?code=${code}&priority=${priority}&categoryName=${categoryName}&status=${status}&sortBy=${sortBy}&page=${currentPage - 1}">Previous</a>
                                </li>
                                <c:forEach begin="1" end="${totalPages}" var="i">
                                    <li class="page-item ${currentPage == i ? 'active' : ''}">
                                        <a class="page-link" href="Category.jsp?code=${code}&priority=${priority}&categoryName=${categoryName}&status=${status}&sortBy=${sortBy}&page=${i}">${i}</a>
                                    </li>
                                </c:forEach>
                                <li class="page-item ${currentPage == totalPages ? 'disabled' : ''}">
                                    <a class="page-link" href="Category.jsp?code=${code}&priority=${priority}&categoryName=${categoryName}&status=${status}&sortBy=${sortBy}&page=${currentPage + 1}">Next</a>
                                </li>
                            </ul>
                        </nav>
                    </div>
                ...
                <c:if test="${empty data}">
                    <p class="debug">Debug: No data received. Total categories: ${totalCategories}, Total pages: ${totalPages}, Sort: ${sortBy}</p>
                </c:if>
            </div> <!-- end content -->
        </div> <!-- end row -->
